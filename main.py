...
new_year_phrase = [
    "{}, печатает новогоднее поздравление."
    "{}, хочет поздравить всех с новым годом.",
    "{}, зачем-то начал печатать, наверное поздравление всем пишет.",
    "{}, давайте обойдемся без @everyоne.",
    "{}, ты сегодня красивый, с новым годом.",
    "{}, тут так жарко или это ты пишешь новогоднее поздравление?",
    "{}, а ты ничего такой, новогдненький.",
    "{}, ля какая.",
    "{}, выйди отсюда, разбiйник. С новiм годом!",
    "{}, сегодня ты очень даже ничего.",
    "{}, выйди и войди нормально, новогодний ты наш.",
    "{}, а ты сегодня нарядил ёлку?",
    "{}, хватит печатать, иди лучше маме помоги стол накрыть.",
    "{}, печатаешь? Печата... печатай...",
    "{}, ты кто такой? Ах да, ты же сегодня празднуешь новый год.",
    "{}, с праздником!",
    "{}, а ты знал, что первый новый год начинается не в Москве?",
    "{}, Санкт-Петербург или Москва?",
    "{}, в 1941 оставалось ровно 365 до 1942.",
    "{}, с новым годом.",
    "{}, иногда стоит задуматься, а зачем ты печатаешь новогоднее  поздравление.",
    "{}, сегодня завтра будет новый год.",
    "{}, мой сервер, мои правила (с) Сергей. С новым годом.",
    "{}, устали печатать? Дайте отдохнуть своим пальцам.",
    "{}, а ты тварь, чертило, чтобы ты новый год в квартире провел с родными и близкими."]
...
class Katherine(discord.Client):
    ...
    def events(self):
        ...
        @self.client.event
        async def on_typing(channel, author, date):
            if channel.id == 584053754504937493:
                await channel.send(random.choice(new_year_phrase).format(author.mention))
