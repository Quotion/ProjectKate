...
dont_write = "{}, вы не писали заявку на РП-сессию." \
             "\nЗаполнение заявки: {}заявка `<ник>` `<роль>` <`станция`(для маневровых и дсцп)/`номер маршрута`(для машиниста)/`линия`(для дцх)> <`линия`(дцх здесь ничего указывать не надо)>"
...
to_many_dch = "{}, вы указали слишком много (или мало) параметров для этой роли.\nПример: {}заявка AlbertTurboPushka`(ник)` 1`(линия)`"

success_add_dch = "{}, вы успешно добавлены на РП-сессию в роли `ДЦХ` по {}-й линии."

success_add_dscp = "{}, вы успешно добавлены на РП-сессию в роли `ДСЦХ` по станции `{}`."

success_add_shunting_driver = "{}, вы успешно добавлены на РП-сессию в роли `Маневрового Машиниста`.\nЛиния `{}`\nСтанция: `{}`"

success_add_driver = "{}, вы успешно добавлены на РП-сессию в роли `Машиниста`.\nЛиния `{}`\nНомер маршрута: `{}`"

dch_already_taken = "{}, ДЦХ уже есть на линии."

dscp_already_taken = "{}, ДСЦП уже есть на такой станции."
