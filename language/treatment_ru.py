...
not_enough_gold = "{}, недостаточно средст." \
                  ...
                  "\nPremium теперь продается в автодонате сервера."
...
promo_event = ["Продам {} {} бесплатно.\nПромокод - `{}`",
               "Тут мне администраторы нашептали, что стоит вам дать кое-что интересное на {} {}\nПромокод - `{}`",
               "Uno, uno, uno, dos, cuatro. Промокодами на {} {}\nПромокод - `{}`",
               "А вы знали что на sunrise есть бесплатное пиво? И мы не знали. В прочем, еще есть промокод на {} {}\nПромокод - `{}`",
               "Ало Галочка, ты сейчас умрешь. У меня есть промокод на {} {}\nВставте текст: `{}`",
...
check_message = "Сообщение будет удалено через минуту.\nПрежде чем ставить ✅, **__провертье приказ/распоряжение на корректность!__**"

order_still_not_check = "{}, предыдущий приказ является не подтвержденным. Подтвердите его или же отклоните."

order_not_check = "Приказ является НЕ ПОДТВЕРЖДЕНЫМ.\nНажмите на ✅, что подтвердить его."

order_check = "Приказ является ПОДТВЕРЖДЕНЫМ.\nПодтвердил: {}"

message_send = "Сообщение было отправлено в канал, который вы указали.\n**__Изменить текст уже не удасться!__**"

message_send_in_this_channel = "Сообщение было отправлено в этот канал."

missing_parameters_orders = "{}, в команде неверно введены параметры. Пример {}заступить 24 Николай Фоменко"
